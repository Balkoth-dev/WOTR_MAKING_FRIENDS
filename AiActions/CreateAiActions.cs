...
namespace WOTR_MAKING_FRIENDS.AiActions
{
    internal class CreateAiActions
    {
        ...
        {
            BlueprintAiCastSpell aiAction = BlueprintConfigurator<BlueprintAiCastSpell>.New("FormOfTheDragonIGoldAiAction", GetGUID.GUIDByName("FormOfTheDragonIGoldAiAction")).CopyFrom(redDragonWoundWorm_BreathAIAction).ConfigureWithLogging();
        ...
        {
            BlueprintAiCastSpell aiAction = BlueprintConfigurator<BlueprintAiCastSpell>.New("FormOfTheDragonISilverAiAction", GetGUID.GUIDByName("FormOfTheDragonISilverAiAction")).CopyFrom(redDragonWoundWorm_BreathAIAction).ConfigureWithLogging();
        ...
        {
            BlueprintAiCastSpell aiAction = BlueprintConfigurator<BlueprintAiCastSpell>.New("FormOfTheDragonIBlackAiAction", GetGUID.GUIDByName("FormOfTheDragonIBlackAiAction")).CopyFrom(redDragonWoundWorm_BreathAIAction).ConfigureWithLogging();
        ...
        {
            BlueprintAiCastSpell aiAction = BlueprintConfigurator<BlueprintAiCastSpell>.New("FormOfTheDragonIBlueAiAction", GetGUID.GUIDByName("FormOfTheDragonIBlueAiAction")).CopyFrom(redDragonWoundWorm_BreathAIAction).ConfigureWithLogging();
        ...
        {
            BlueprintAiCastSpell aiAction = BlueprintConfigurator<BlueprintAiCastSpell>.New("FormOfTheDragonIBrassAiAction", GetGUID.GUIDByName("FormOfTheDragonIBrassAiAction")).CopyFrom(redDragonWoundWorm_BreathAIAction).ConfigureWithLogging();
        ...
        {
            BlueprintAiCastSpell aiAction = BlueprintConfigurator<BlueprintAiCastSpell>.New("FormOfTheDragonIGreenAiAction", GetGUID.GUIDByName("FormOfTheDragonIGreenAiAction")).CopyFrom(redDragonWoundWorm_BreathAIAction).ConfigureWithLogging();
