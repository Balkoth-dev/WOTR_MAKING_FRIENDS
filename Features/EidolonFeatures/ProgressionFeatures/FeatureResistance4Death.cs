...
{
    public static class FeatureResistance4Death
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "Resistance4Death";
            ...
            internal static Sprite Icon = FeatureRefs.ImmunityToDeathEffects.Reference.Get().m_Icon;
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddSavingThrowBonusAgainstDescriptor(bonus: 4, spellDescriptor: new SpellDescriptorWrapper() { m_IntValue = (long)SpellDescriptor.Death })
