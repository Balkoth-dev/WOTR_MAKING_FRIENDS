...
{
    public static class FeatureAddAbilityUnnervingGazeArea
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddAbilityUnnervingGazeArea";
        ...
        internal static void CreateAbility()
        {
            ...
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                ...
                .AddAbilityDeliverChain(targetDead: false, targetType: TargetType.Enemy, targetsCount: 2, radius: 15.Feet(), projectile: ProjectileRefs.Dummy00_Projectile.Cast<BlueprintProjectileReference>(), projectileFirst: ProjectileRefs.Dummy00_Projectile.Cast<BlueprintProjectileReference>())
