...
{
    public static class FeatureDR5Good
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "DR5Good";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddDamageResistancePhysical(value: ContextValues.Constant(5), alignment: DamageAlignment.Good, bypassedByAlignment: true)
