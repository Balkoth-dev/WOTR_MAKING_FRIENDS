...
{
    public static class FeatureDR10Magic
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "DR10Magic";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddDamageResistancePhysical(value: ContextValues.Constant(10), bypassedByMagic: true)
