...
{
    public static class FeatureImmunityAbilityDamage
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "ImmunityAbilityDamage";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    .CopyFrom(FeatureRefs.ImmunityToAbilityDamage, c => true)
