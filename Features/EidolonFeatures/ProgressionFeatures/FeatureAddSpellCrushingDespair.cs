...
{
    public static class FeatureAddSpellCrushingDespair
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "EidolonAddSpellCrushingDespair";
            ...
            internal static Sprite Icon = AbilityRefs.CrushingDespair.Reference.Get().m_Icon;
