...
{
    public static class FeatureImmunityEnergyDrain
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "ImmunityEnergyDrain";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    .CopyFrom(FeatureRefs.ImmunityToEnergyDrain, c => true)
