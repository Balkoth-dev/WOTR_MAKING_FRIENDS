...
namespace WOTR_MAKING_FRIENDS.Features.EidolonFeatures.ProgressionFeatures
{
    public static class FeatureAddSpellTransmogrify
    {
        ...
        {
            internal static string ProgressionFeature = "Eidolon" + "AddSpellTransmogrify";
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(BlueprintTool.GetRef<BlueprintAbilityReference>("TransmogrifySpell"), c => true)
