...
{
    public static class FeatureDR5Lawful
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "DR5Lawful";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddDamageResistancePhysical(value: ContextValues.Constant(5), alignment: DamageAlignment.Lawful, bypassedByAlignment: true)
