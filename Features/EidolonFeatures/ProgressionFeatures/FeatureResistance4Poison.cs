...
{
    public static class FeatureResistance4Poison
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "Resistance4Poison";
            ...
            internal static Sprite Icon = FeatureRefs.ImmunityToPoison.Reference.Get().m_Icon;
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    .CopyFrom(FeatureRefs.PoisonResistance4Feature, c => true)
