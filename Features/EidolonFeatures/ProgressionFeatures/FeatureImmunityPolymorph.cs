...
{
    public static class FeatureImmunityPolymorph
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "ImmunityPolymorph";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    .CopyFrom(FeatureRefs.ImmunityToPolymorph, c => true)
