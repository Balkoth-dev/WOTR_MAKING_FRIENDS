...
{
    public static class FeatureAddSpellBlink
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddSpellBlink";
            ...
            internal static Sprite Icon = AbilityRefs.Blink.Reference.Get().m_Icon;
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(AbilityRefs.Blink, c => c is not ContextRankConfig)
