...
{
    public static class FeatureAddSpellInvisibility
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddSpellInvisibility";
            ...
            internal static Sprite Icon = AbilityRefs.Invisibility.Reference.Get().m_Icon;
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(AbilityRefs.Invisibility, c => c is not ContextRankConfig)
