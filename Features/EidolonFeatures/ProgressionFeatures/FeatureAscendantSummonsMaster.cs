...
{
    public static class FeatureAscendantSummonsMaster
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AscendantSummonsMaster";
            ...
            internal static Sprite Icon = FeatureRefs.AscendantSummonsCaster.Reference.Get().m_Icon;
            internal static FeatureGroup featureGroup = FeatureGroupExtension.EvolutionBase;
            internal static int Ranks = 1;
        }
        public static class IClassBuff
        {
            internal const string BuffName = "AscendantSummonsMaster";
        ...
        private static void CreateIsMasterBuff()
        {
            BuffConfigurator.New(IClassBuff.BuffIsMaster, GetGUID.GUIDByName(IClassBuff.BuffIsMaster))
                ...
                .SetStacking(StackingType.Ignore)
                .SetIcon(IClass.Icon)
                .AddFacts(new() { FeatureRefs.AscendantSummonsCaster.Cast<BlueprintUnitFactReference>() })
                .ConfigureWithLogging();
        }
    }
}
