...
{
    public static class FeatureResistance4Curses
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "EidolonResistance4Curses";
            ...
            internal static Sprite Icon = FeatureRefs.ImmunityToCurseEffects.Reference.Get().m_Icon;
