...
{
    public static class FeatureAddAbilityConsumeFear
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddAbilityConsumeFear";
            ...
            internal static Sprite Icon = AbilityRefs.ConsumeFear.Reference.Get().m_Icon;
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(AbilityRefs.ConsumeFear, c => c is not ContextRankConfig)
