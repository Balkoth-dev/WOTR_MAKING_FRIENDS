...
{
    public static class FeatureDR10Evil
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "DR10Evil";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddDamageResistancePhysical(value: ContextValues.Constant(10), alignment: DamageAlignment.Evil, bypassedByAlignment: true)
