...
{
    public static class FeatureAddSpellTrueSeeing
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddSpellTrueSeeing";
            ...
            internal static Sprite Icon = AbilityRefs.TrueSeeing.Reference.Get().m_Icon;
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(AbilityRefs.TrueSeeing, c => c is not ContextRankConfig)
