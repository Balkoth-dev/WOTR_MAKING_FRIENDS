...
{
    public static class FeatureModerateFortification
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "ModerateFortification";
            ...
            internal static Sprite Icon = FeatureRefs.Fortification50Feature.Reference.Get().m_Icon;
