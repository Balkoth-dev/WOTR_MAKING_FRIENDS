...
{
    public static class FeatureResistance4Disease
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "EidolonResistance4Disease";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddSavingThrowBonusAgainstDescriptor(bonus: 4, spellDescriptor: new SpellDescriptorWrapper() { m_IntValue = (long)SpellDescriptor.Disease })
