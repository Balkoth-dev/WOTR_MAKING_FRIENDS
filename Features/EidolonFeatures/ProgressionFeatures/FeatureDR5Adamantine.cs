...
{
    public static class FeatureDR5Adamantine
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "DR5Adamantine";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddDamageResistancePhysical(value: ContextValues.Constant(5), material: PhysicalDamageMaterial.Adamantite)
