...
{
    public static class FeatureImmunityDeath
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "ImmunityDeath";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    .CopyFrom(FeatureRefs.ImmunityToDeathEffects, c => true)
