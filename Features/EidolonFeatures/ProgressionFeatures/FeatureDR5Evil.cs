...
{
    public static class FeatureDR5Evil
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "DR5Evil";
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddDamageResistancePhysical(value: ContextValues.Constant(5), alignment: DamageAlignment.Evil, bypassedByAlignment: true)
