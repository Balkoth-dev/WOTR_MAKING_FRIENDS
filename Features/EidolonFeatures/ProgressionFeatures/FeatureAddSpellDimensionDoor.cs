...
{
    public static class FeatureAddSpellDimensionDoor
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddSpellDimensionDoor";
            ...
            internal static Sprite Icon = AbilityRefs.DimensionDoor.Reference.Get().m_Icon;
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(AbilityRefs.DimensionDoor, c => true)
                .ConfigureWithLogging();
        }
    }
}
