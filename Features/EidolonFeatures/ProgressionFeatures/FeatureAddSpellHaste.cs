...
{
    public static class FeatureAddSpellHaste
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "AddSpellHaste";
            ...
            internal static Sprite Icon = AbilityRefs.Haste.Reference.Get().m_Icon;
        ...
        internal static void CreateAbility()
        {
            AbilityConfigurator.New(IClassAbility.Ability, IClassAbility.Guid)
                .CopyFrom(AbilityRefs.Haste, c => c is not ContextRankConfig)
