...
{
    public static class FeatureResistance4Mind
    {
        public static class IClass
        {
            internal static string ProgressionFeature = "Eidolon" + "Resistance4Mind";
            ...
            internal static Sprite Icon = FeatureRefs.ImmunityToMindAffecting.Reference.Get().m_Icon;
        ...
        internal static void CreateFeature()
        {
            ...
            FeatureConfigurator.New(IClass.Feature, IClass.Guid)
                    ...
                    .AddSavingThrowBonusAgainstDescriptor(bonus: 4, spellDescriptor: new SpellDescriptorWrapper() { m_IntValue = (long)SpellDescriptor.MindAffecting })
